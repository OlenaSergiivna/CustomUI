...
extension UIView {
    ...
    func fixInView(_ container: UIView!, topConstant: CGFloat = 0, bottomConstant: CGFloat = 0, isActiveBottom: Bool = true, leadingConstant: CGFloat = 0, trailingConstant: CGFloat = 0, isActiveTrailing: Bool = true) -> Void {
        ...
        NSLayoutConstraint(item: self, attribute: .trailing, relatedBy: .equal, toItem: container, attribute: .trailing, multiplier: 1.0, constant: trailingConstant).isActive = isActiveTrailing
